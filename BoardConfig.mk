...
# Decide to override 32bit builds
...
TARGET_RECOVERY_WIPE := device/mediatek/mt6833/conf/recovery.wipe
...
# SoundTriggerHAL Configuration / remove the need for this
...
# GNSS
# BOARD_USES_EXYNOS_GNSS_DUMMY := true # mp

# Bluetooth defines
# TODO: Remove the dep for this
...
#TODO: eval powersave kernel redundancies
...
#include device/samsung/a14mx-sepolicy/sepolicy.mk
...
#TODO: add pixel mainline BoardConf make flags
